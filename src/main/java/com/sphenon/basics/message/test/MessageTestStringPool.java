...
public class MessageTestStringPool extends StringPoolClass {
    static protected MessageTestStringPool singleton = null;

    static public MessageTestStringPool getSingleton (CallContext cc) {
        if (singleton == null) {
            singleton = new MessageTestStringPool(cc);
        }
        return singleton;
    }
    ...
    protected MessageTestStringPool (CallContext cc) {
        super(cc);
        /*************************************************/
        ...
        //P-0-com.sphenon.basics.message.test
        //F-0-0-Test.java
        addEntry(cc, "0.0.0", "en", "Test Message");
        addEntry(cc, "0.0.1", "en", "Test Message with Parameter: %(gruss), world!");
        //END-OF-STRINGS
        /*************************************************/
    }
}
