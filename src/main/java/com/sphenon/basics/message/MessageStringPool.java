...
public class MessageStringPool extends StringPoolClass {
    static protected MessageStringPool singleton = null;

    static public MessageStringPool getSingleton (CallContext cc) {
        if (singleton == null) {
            singleton = new MessageStringPool(cc);
        }
        return singleton;
    }
    ...
    protected MessageStringPool (CallContext cc) {
        super(cc);
        /*************************************************/
